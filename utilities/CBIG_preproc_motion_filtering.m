...
%   - f_max & f_min:
%     If f_min is empty, we use low pass filter and f_max is the stop frequency;
%     if both f_min and f_max are provided we use bandpass filter and the
%     passband is [f_min,f_max]
%
% Outputs:
%
%   - motion_filt
...
%
% Reference: Fair, Damien A., et al. "Correction of respiratory artifacts in MRI head motion estimates."
