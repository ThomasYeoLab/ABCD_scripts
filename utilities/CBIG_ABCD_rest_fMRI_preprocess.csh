#! /bin/csh -f
##########################################
# CBIG ABCD rest fMRI Preprocess
##########################################
# AUTHOR #################################
# Jianzhong Chen
# 2020/02/24  
...
set VERSION = '$Id: CBIG_ABCD_rest_fMRI_preprocess.csh, v 1.0 2020/02/24 $'
...
foreach step ( "`cat $config`" )
	...
	##########################################		
		...
		set mc_stem = "_rest_mc"
		set BOLD_stem = "_rest_mc"
...
NAME:
	CBIG_ABCD_rest_fMRI_preprocess.csh

DESCRIPTION:
	The pipeline processes ABCD minimaly processing rest fMRI data and projects the data to 
