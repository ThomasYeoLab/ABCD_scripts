...
export CBIG_CODE_DIR=/data/users/jzchen/storage/CBIG_private
...
# personalized setting for convenience
export ABCD_data_dir=/mnt/eql/yeo12/data/ABCD/rawData
export ABCD_scripts_dir=/mnt/eql/yeo13/data/ABCD/scripts
export ABCD_task_dir=/mnt/eql/yeo5/data/ABCD/task-fMRI
